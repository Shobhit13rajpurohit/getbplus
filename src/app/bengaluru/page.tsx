...
import { CheckCircle2, Plane, MapPin, Store, Car, Bot, Briefcase } from 'lucide-react'

export const metadata = {
  title: 'Pay in Bengaluru with Foreign Card | GetB+ India — Airport to Market',
  description: 'International tourists and expats: pay at Bengaluru tech parks, MG Road, and airport taxis with your Visa or Mastercard. GetB+ at KIAL Terminal 2.'
}
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 bg-navy overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1596176530529-78163a4f7af2?auto=format&fit=crop&q=80&w=2000")' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-5xl md:text-6xl font-bold leading-tight text-white mb-6">
            Arriving in Bengaluru? <br/>
            <span className="text-gold">GetB+ Has You Covered from Terminal to Tech Park.</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
            Pay at any shop or pub, get AI travel guidance, book your airport cab, and store luggage — all in one app.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <div className="text-gray-300 font-medium px-6 py-3 border border-white/20 rounded-full bg-white/5 backdrop-blur-sm flex items-center gap-2">
              <Plane size={18} className="text-gold" /> Find our activation desk at KIAL T2 Arrivals
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-12">We&apos;re at Bengaluru KIAL When You Land.</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col justify-center">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500">KIAL Terminal 2</p>
                </div>
              </div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  <MapPin className="text-gray-400 w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Location:</strong> International Arrivals Hall</span>
                </li>
                <li className="flex items-start gap-3">
                  <Store className="text-gray-400 w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Hours:</strong> 24/7 Operation</span>
                </li>
                <li className="flex items-start gap-3">
                  <Bot className="text-gray-400 w-5 h-5 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700"><strong>Languages:</strong> English, Kannada, Hindi</span>
                </li>
              </ul>
              <div className="bg-navy/5 p-4 rounded-xl border border-navy/10 text-navy font-medium">
                Our team helps you set up GetB+ before you exit the terminal.
              </div>
            </div>
            <div className="bg-gray-200 rounded-2xl h-full min-h-[400px] relative overflow-hidden flex flex-col items-center justify-center">
              ...
              <div className="bg-white px-4 py-2 rounded-full font-bold shadow-md mt-2 z-10 text-navy">KIAL T2 map view</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-12">Where You&apos;ll Use GetB+ in Bengaluru</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              "MG Road Stores", "Brigade Road Pubs", "Indiranagar Cafes",
              "UB City Mall", "Jayanagar Markets", "Whitefield Tech Parks",
              "Namma Metro", "Koramangala Eateries"
            ].map((loc, i) => (
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden text-left max-w-3xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-3 border-b border-white/5 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">KIAL → MG Road</div>
              <div className="font-bold text-green-400">₹750</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
            <div className="grid grid-cols-3 border-b border-white/5 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">KIAL → Indiranagar</div>
              <div className="font-bold text-green-400">₹700</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
            <div className="grid grid-cols-3 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">KIAL → Whitefield</div>
              <div className="font-bold text-green-400">₹600</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
          </div>
          <Link href="/transport" className="text-gold font-medium hover:underline inline-flex items-center">
            See All Bengaluru Routes →
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-16">Ask GetB+ AI About Bengaluru</h2>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;What&apos;s the best time to leave for the airport from Koramangala?&quot;</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;Is it easy to find an auto near MG Road?&quot;</div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold text-navy mb-6">Store Your Bags in Bengaluru</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Coverage zones include MG Road, Brigade Road, Indiranagar, and Whitefield.
          </p>
      ...
      <section className="py-24 bg-navy-dark text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-8">
          <h2 className="text-4xl font-bold text-white">Ready for Bengaluru? Set Up GetB+ Before Your Flight.</h2>
