...
export const metadata = {
  title: 'Pay in Delhi with Foreign Card | GetB+ India — Airport to Market',
  description: 'International tourists: pay at Delhi markets, Red Fort, and auto-rickshaws with your Visa or Mastercard. GetB+ at IGI Terminal 3.'
}
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 bg-navy overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1587474260584-136574528ed5?auto=format&fit=crop&q=80&w=2000")' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <div className="text-gray-300 font-medium px-6 py-3 border border-white/20 rounded-full bg-white/5 backdrop-blur-sm flex items-center gap-2">
              <Plane size={18} className="text-gold" /> Find our activation desk at IGI T3 International Arrivals
            </div>
          </div>
        </div>
      </section>

      {/* 2. GETB+ AT DELHI AIRPORT */}
      <section className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-12">We&apos;re at Delhi IGI When You Land.</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col justify-center">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500">IGI Terminal 3</p>
                </div>
              </div>
            ...
            <div className="bg-gray-200 rounded-2xl h-full min-h-[400px] relative overflow-hidden flex flex-col items-center justify-center">
              ...
              <div className="bg-white px-4 py-2 rounded-full font-bold shadow-md mt-2 z-10 text-navy">IGI Terminal 3 map view</div>
            </div>
          </div>
        </div>
      </section>

      {/* 3. DELHI PAYMENT GUIDE */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-12">Where You&apos;ll Use GetB+ in Delhi</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              "Chandni Chowk markets", "Connaught Place restaurants", "Red Fort ticketing",
              "Karol Bagh shopping", "Lajpat Nagar bazaar", "Dilli Haat crafts",
              "Auto-rickshaws citywide", "Agra day-trip vendors"
            ].map((loc, i) => (
      ...
      {/* 4. TRANSPORT FROM DELHI AIRPORT */}
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden text-left max-w-3xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-3 border-b border-white/5 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">IGI → Connaught Place</div>
              <div className="font-bold text-green-400">₹400</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
            <div className="grid grid-cols-3 border-b border-white/5 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">IGI → Aerocity</div>
              <div className="font-bold text-green-400">₹200</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
            <div className="grid grid-cols-3 border-b border-white/5 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">IGI → South Delhi</div>
              <div className="font-bold text-green-400">₹550</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
            <div className="grid grid-cols-3 p-4 items-center hover:bg-white/5 transition-colors">
              <div className="font-medium text-white">IGI → Gurgaon</div>
              <div className="font-bold text-green-400">₹850</div>
              <div className="text-right"><Button variant="default" size="sm" className="bg-white text-navy hover:bg-gray-200">Book</Button></div>
            </div>
          </div>
          <Link href="/transport" className="text-gold font-medium hover:underline inline-flex items-center">
            See All Delhi Routes →
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-navy mb-16">Ask GetB+ AI About Delhi</h2>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-10">
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;What&apos;s a fair auto fare from CP to Red Fort?&quot;</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;Is Paharganj safe to walk at night?&quot;</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;How much should I pay for a rickshaw in Old Delhi?&quot;</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex items-center gap-4">
              <Bot className="text-teal-500 w-8 h-8 flex-shrink-0" />
              <div className="text-gray-700 italic font-medium">&quot;Best way from Delhi to Agra for a day trip?&quot;</div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold text-navy mb-6">Store Your Bags in Delhi</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Drop your bags safely while you explore. Coverage zones include Paharganj, Connaught Place, South Delhi, and the IGI Airport zone.
          </p>
      ...
      <section className="py-24 bg-gold relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <h2 className="text-3xl font-bold text-navy mb-12 text-center">Stay Safe in Delhi — AI-Powered Alerts</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              "Fake travel agents near Connaught Place",
              "Auto drivers to \"closed\" tourist sites",
              "Gem export business \"opportunities\"",
              "Prepaid taxi scams at airport exits"
            ].map((scam, i) => (
      ...
      <section className="py-24 bg-navy-dark text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-8">
          <h2 className="text-4xl font-bold text-white">Ready for Delhi? Set Up GetB+ Before Your Flight.</h2>
